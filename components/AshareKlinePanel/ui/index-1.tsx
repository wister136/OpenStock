  ...
  return (
    <div className="rounded-2xl border border-white/5 bg-[#0d0d0d] overflow-hidden">
      ...
      <Dialog open={dlgOpen} onOpenChange={setDlgOpen}>
        <DialogContent className="w-[90vw] max-w-[90vw] h-[90vh] max-h-[90vh] border-white/10 bg-[#0d0d0d] text-white overflow-hidden">
          <DialogHeader>
            <DialogTitle>
              ...
              <div className="flex gap-3 h-[74vh]">
                ...
                <div className="flex-1 space-y-3 overflow-auto pr-1">
                  <div className="rounded-xl border border-white/10 bg-white/5 p-3">
                    ...
                    <div className="mt-3">
                      <BacktestConfigPanel config={btConfig} setConfig={setBtConfig} />
                    </div>
