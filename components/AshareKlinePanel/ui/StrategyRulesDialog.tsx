...
const STRATEGY_TARGET_KEY: Record<StrategyKey, string> = {
  ...
  maCross: "ashare.rules.target.ma",
  emaTrend: "ashare.rules.target.ma",
  macdCross: "ashare.rules.target.momentum",
  rsiReversion: "ashare.rules.target.momentum",
  rsiMomentum: "ashare.rules.target.momentum",
  bollingerBreakout: "ashare.rules.target.bollinger",
  bollingerReversion: "ashare.rules.target.bollinger",
  channelBreakout: "ashare.rules.target.breakout",
