          ...
          ? (json.items as any[])
              ...
              .map(
                (it): NewsFeedItem => ({
                  ...
                  region: it.region === 'domestic' || it.region === 'global' ? it.region : undefined,
                  region_reason: typeof it.region_reason === 'string' ? it.region_reason : undefined,
                  region_confidence: typeof it.region_confidence === 'number' ? it.region_confidence : undefined,
